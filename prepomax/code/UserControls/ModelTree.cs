...
namespace UserControls
{
    ...
    public partial class ModelTree : UserControl
    {
        ...
        private string _miNodoName = "Hijo de model";
        // Padre custom

        // Custom tab | Nodes
        private TreeNode _customNode1;
        private TreeNode _customNode2;
        private TreeNode _customNode3;
        private TreeNode _customSubNode;
        private TreeNode _customSubSubNode;

        private string _customNode1Text = "Node one";
        private string _customNode2Text = "Node two";
        private string _customNode3Text = "Node three";
        ...
        public ModelTree()
        {
            ...
            // Custom Tab | Nodes
            _customNode1 = new TreeNode(_customNode1Text);
            _customNode2 = new TreeNode(_customNode2Text);
            _customNode3 = new TreeNode(_customNode3Text);
            _customSubNode = new TreeNode(_customSubNodeText);
            _customSubSubNode = new TreeNode(_customSubSubNodeText);
            
            _customNode1.Name = "customNode1";
            _customNode2.Name = "customNode2";
            _customNode3.Name = "customNode3";
            _customSubNode.Name = "customSubNode";
            _customSubSubNode.Name = "customSubSubNode";
        ...
        {
            // Custom tab. Evitar llamar eventos.
        ...
        public void ClearCustomTab()
        {
            ...
            _customNode2.Nodes.Clear();
            _customNode3.Nodes.Clear();
            _customSubNode.Nodes.Clear();
            _customSubSubNode.Nodes.Clear();
            
            _customNode1.Text = _customNode1Text;
            _customNode2.Text = _customNode2Text;
            _customNode3.Text = _customNode3Text;
            _customSubNode.Text = _customSubNodeText;
            _customSubSubNode.Text = _customSubSubNodeText;

            cltvCustomTab.Nodes.Add(_customNode1);
            cltvCustomTab.Nodes.Add(_customNode2);
            cltvCustomTab.Nodes.Add(_customNode3);
            _customNode1.Nodes.Add(_customSubNode);
            _customSubNode.Nodes.Add(_customSubSubNode);
        ...
        public void AddTreeNode(ViewType view, NamedClass item, string parentName)
        {
            ...
            try
            {
                ...
                else if (item is MeshPart)
                {
                    ...
                    node.Tag = item;
                    // Padre custom
                    TreeNode miNodo = new TreeNode("Hijo de object/model");
                    miNodo.Name = "MiNodo";
                    miNodo.Tag = item;
        ...
        private CodersLabTreeView GetActiveTree()
        {
            ...
            // Custom tab
            else if (tcGeometryModelResults.SelectedTab == tpCustomTab) return cltvCustomTab;
            // Custom tab
        ...
        private CodersLabTreeView GetTree(ViewType view)
        {
            ...
            // Custom tab
            else if (view == ViewType.CustomTab) return cltvCustomTab;
            // Custom tab
