...
# Ejemplo: ./prepare-lenovo-apps.sh ../../script/bash/instruction-get-apps.sh
# Se preparara para jalar sin google.
instruction_get_apps=$1
fdroidcl="$HOME/Programas/fdroidcl/fdroidcl_v0.8.1_linux_amd64"

# Borrar feos lenovo
$instruction_get_apps "adb shell pm disable-user" ./android-remove-apps-lenovo.txt
$instruction_get_apps "adb shell pm uninstall -k --user 0" ./android-remove-apps-lenovo.txt
