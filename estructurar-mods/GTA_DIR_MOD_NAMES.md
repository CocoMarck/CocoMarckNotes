# Grand Theft Auto Reglas de nombres de dirctorios de mods
...
- `artificial-intelligence`: Solo mods relacionados con el comportamiento de los npc.
...
- `0-tools`: Herramientas.
- `0-my-mods`: Solo mods hechos por mi.
- `0-configs`: Configuraciones de mods.
- `0-dependencies`: Dependencias.
- `1-without-order`: Mods sin ordenar.