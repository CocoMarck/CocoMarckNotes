...
Nombres de perfiles en `kebab-case`, o `PascalCase`. Kebab, nomas por comodidad, `PascalCase`; Es para mantener la estrucutra coherente. Nombres en ingles.
...
- `objects-mechanics`: Mods que cambian o agregan mecanismos a objetos del juego. Ya sean armas, vehiculos, y etc.
...
- `world-map`: Mods que son un nuevo mapa. Remplazo total del mapa.
